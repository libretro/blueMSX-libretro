...
void emulatorSetFrequency(int logFrequency, int* frequency) {
    /* (int)(3579545 * pow(2, (logFrequency - 50) / 15.0515)), baked in
     * DetTablesEmuFreq.h (generated by tools/gen_tables.c). */
    if (logFrequency < 0)   logFrequency = 0;
    if (logFrequency > 100) logFrequency = 100;
    emuFrequency = detEmuFreqTable[logFrequency];
